...
const FeaturedJobs = ({ job }) => {
  ...
  return (
    <div className=" border space-x-3 mb-4 p-6 w-[500px] h-[300px]">
      ...
      <p>{jobType}</p>
      <div className="my-4">
        <button className="border border-blue-300 px-1 text-blue-400 font-semibold ">{job.jobCategory[0]}</button>
        <button className="border border-blue-300 px-1 text-blue-400 font-semibold ml-5 ">{job.jobCategory[1]}</button>
      </div>
      <div className="flex items-center space-x-3">
       <div className="flex items-center">
        <p><MapPinIcon className="w-4 text-gray-400"></MapPinIcon></p>
